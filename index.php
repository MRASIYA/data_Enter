...
<table id="entryTable">
    ...
    function addEntry() {
        ...
        quantityCell.innerHTML = `<input type="number" value="${quantity}" onchange="updateQuantity(this, ${entries.length - 1})">`;
        actionCell.innerHTML = `<button onclick="deleteEntry(this, ${entries.length - 1})">❌ Delete</button>`;
    ...
    function updateQuantity(input, index) {
        // Update the quantity in the entries array
        entries[index].quantity = parseInt(input.value);
    }
    ...
    function deleteEntry(button, index) {
        ...
        // Rebuild the table to update indices
        rebuildTable();
    }
    ...
    function rebuildTable() {
        ...
        // Rebuild rows from the entries array
        entries.forEach((entry, index) => {
            ...
            quantityCell.innerHTML = `<input type="number" value="${entry.quantity}" onchange="updateQuantity(this, ${index})">`;
            actionCell.innerHTML = `<button onclick="deleteEntry(this, ${index})">❌ Delete</button>`;
        });
    }
